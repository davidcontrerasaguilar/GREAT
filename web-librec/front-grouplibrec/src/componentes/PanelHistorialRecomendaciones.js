        ...
        <>
            {
                ...
                <>
                    ...
                    <button id='j-history' className="button is-primary is-rounded is-light" onClick={abrirPanelIndividual}>
                        ...
                        <div className="column">
                            <div className="column">
                                ...
                                */}
                                    ...
                                    <button className={`button ${buttonRecommend? 'is-loading': ''}`} disabled={buttonRecommend} style={styleButtonItem} onClick={() => props.enviarAlStack(itemInfo.idItem)}>
