...
import { faHeart, faMusic, faHeadphonesSimple, faTrophy, faSpinner } from "@fortawesome/free-solid-svg-icons"
    ...
    const puntuacionItem = async (valor) => {
        try {
            ...
            if (idUsuario && idItem) {
                ...
                setPuntuacion(valor)
                socket.emit("calificar-favorito-grupo", idGrupo)
            }
                        ...
                        <div className="columns">
                            ...
                            <div className="column">
                                ...
                                {props.chat &&
                                    ...
                                    <div className="columns">
                                        <div className="column">
                                            <button className={`button ${buttonRecommend? 'is-loading': ''}`} style={styleButtonItem} onClick={() => props.enviarAlStack(idItem)} disabled={buttonRecommend}>
