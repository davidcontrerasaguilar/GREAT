...
const PanelFavoritos = (props) => {
    ...
    const eliminarDelStack = async (idGrupo, idItem) => {
        try {
            ...
            const verificar_eliminar = await api.get("check-eliminar", { params: { idGrupo } }, {
                headers: {
                    "Content-type": "application/json"
                }
            } )
            if (!verificar_eliminar.data.delete){
                window.alert(t('main.warning'))
        ...
        <div>
            <div className="columns" >
                <div className="column has-text-centered">
                    <button id='j-fav' className="button is-danger is-light is-rounded is-large" onClick={abrirPanelFavoritos}>
