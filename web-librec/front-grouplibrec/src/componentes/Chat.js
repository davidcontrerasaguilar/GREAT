...
import { faCrown, faHeart, faHeartBroken, faPaperPlane, faPeopleGroup } from "@fortawesome/free-solid-svg-icons"
                    ...
                    <p style={{ paddingLeft: "10px", paddingRight: "10px", paddingTop: "2px", paddingBottom: "2px" }}>
                            ...
                            (
                                <a className="hover-text" onClick={() => setEstadoItem(true)} style={{ color: "#0969b3"}}>
                                    {props.mensaje.usuarioDestinoID === props.idUsuario ? (
                                        <span>
                                            <FontAwesomeIcon icon={faPeopleGroup} style={{ color: "#0969b3" }}/>
                                            <span> </span>
                        ...
                        }
                        {
                            ...
                            <a className="hover-text" onClick={() => setEstadoItem(true)} style={{ color: "#b30925"}}>
                                <FontAwesomeIcon icon={faHeart} style={{ color: "#b30925" }}/>
                                <span> </span>
                        ...
                        }
                        {
                            ...
                            <a className="hover-text" onClick={() => setEstadoItem(true)} style={{ color: "#b30925"}}>
                                <FontAwesomeIcon icon={faHeartBroken} style={{ color: "#b30925" }}/>
                                <span> </span>
